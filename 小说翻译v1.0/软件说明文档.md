...
## 项目概述
本项目目前是一个轻小说翻译系统，也支持多语言的文档翻译，具备缓存管理、格式保留、错误重试和UI界面。系统集成了DeepSeek翻译API，目前主要对轻小说的翻译做了优化，该项目代码主要由AI完成，如有需要修改的地方可以自行随意修改。

## 使用方法

### 启动系统

- ==首次运行前请输入个人申请的API密钥，密钥可以到DeepSeek开放平台自行申请。==
